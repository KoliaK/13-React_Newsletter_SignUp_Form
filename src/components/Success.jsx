  ...
  return(
    <Card>
      <div className="text_box success_container">
        ...
        <h2 className="text">A confirmation email has been sent to <span className="email_span">{ userEmail }</span>. Please open it and click the button inside to confirm your subscription</h2>
